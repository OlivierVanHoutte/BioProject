...
We kiezen dan 8 sets uit onze 15, en wijzen aan elk van deze sets 1 getal tussen 0 en 7 toe. We geven ze ook telkens een nieuwe letter indien nodig, zodat we deze makkelijker in string vorm kunnen representeren.
\newline   
...
\noindent
We kunnen nu weer een string van bits omzetten naar De gekozen sets. Als het aantal bits niet deelbaar is door 3, voegen we de nodige bits toe aan het begin van de string.
\newline
...
\noindent
We bouwen nu zoveel strings als we willen. Dit kan zeer efficiënt met moderne technieken.
Wanneer we de data terug willen decoden, kieze we weer een aantal DNA strings uit de gegenereerde strings.
We checken welke basen we terug vinden, en achterhalen zo welke corresponderende letter hier mee overeen komt.
\newline

\noindent
vb: We zien op positie 3, in verschillende strings, de characters A en C. Dan weten we dat dit een Y representeert.

Stel dat er maar 1 soort base wordt gelezen op een bepaalde positie. Dan zijn er 2 opties. 
